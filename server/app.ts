...
app.post('/api/auth/collaborator/login', async (req: Request, res: Response) => {
  try {
...
app.get('/api/collaborator/me', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
app.get('/api/collaborator/inbox', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
...
app.patch('/api/collaborator/messages/:id/read', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
    const { id } = req.params;
...
app.delete('/api/collaborator/messages/:id', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
    const { id } = req.params;
...
app.patch('/api/collaborator/messages/:id/react', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
    const { id } = req.params;
...
app.post('/api/collaborator/messages/:id/thank', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
    const { id } = req.params;
    const { note } = req.body;
...
app.get('/api/collaborator/notifications', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
...
app.post('/api/collaborator/notifications/mark-read', requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const col = req.collaborator!;
...
app.get('/api/recipients', optionalCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
app.post('/api/messages', rateLimitMiddleware, requireCollaboratorAuth, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
app.get('/api/admin/auth/verify', requireAdminAuth, (_req, res) => {
...
app.get('/api/admin/messages/export', requireAdminAuth, async (_req, res) => {
  try {
...
app.get('/api/admin/recipients', requireAdminAuth, async (_req, res) => {
  try {
...
app.post('/api/admin/recipients', requireAdminAuth, async (req, res) => {
  try {
...
app.put('/api/admin/recipients/:id', requireAdminAuth, async (req, res) => {
  try {
    const { id } = req.params;
    const { full_name, email, operation, role, active } = req.body;
...
app.delete('/api/admin/recipients/:id', requireAdminAuth, async (req, res) => {
  try {
    const { id } = req.params;
...
app.post('/api/admin/recipients/import-list', requireAdminAuth, async (req, res) => {
  try {
...
app.post('/api/admin/recipients/import', requireAdminAuth, async (req, res) => {
  try {
    const { csv } = req.body;
